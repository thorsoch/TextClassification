...
# Function that takes in a WORD and 
# returns it stemmed as a string.
...
if __name__ == "__main__":
	...
	with open("allwordsstem", 'wb') as f:
	...
	with open("childstem.csv", "wb") as f:
		writer = csv.writer(f)
	...
	with open("historystem.csv", "wb") as f:
		writer = csv.writer(f)
		writer.writerows(matrix)
	...
	with open("religionstem.csv", "wb") as f:
		writer = csv.writer(f)
		writer.writerows(matrix)
	...
	with open("sciencestem.csv", "wb") as f:
		writer = csv.writer(f)
		writer.writerows(matrix)
