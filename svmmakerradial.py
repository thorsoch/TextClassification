...
print("Training c = 15, gamma = 15 Model")

clf = svm.SVC(kernel = 'rbf', C = 15, gamma = 15, verbose = True)

ok = clf.fit(X, Y)

# Change the model name.

print("Writing c = 15, gamme = 15 Model")

with open("goodSVM_radial_15_15", "wb") as f:
	pickle.dump(ok, f)
