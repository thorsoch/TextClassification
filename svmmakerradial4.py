...
print("Training c = 7.65, gamma = 81.667 Model")

clf = svm.SVC(kernel = 'rbf', C = 7.65, gamma = 81.667, verbose = True)

ok = clf.fit(X, Y)

# Change the model name.

print("Writing c = 7.65, gamme = 81.667 Model")

with open("goodSVM_radial_7_65_81667_word", "wb") as f:
	pickle.dump(ok, f)
