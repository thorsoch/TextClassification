...
with open("goodSVM_radial_7_5_81667_word", "rb") as f: #"goodSVM"
...
print("Writing out testsvmpred_radial_7_5_81667.csv")

with open("testsvmpred_radial_7_5_81667.csv", "wb") as f:
	writer = csv.writer(f)
	writer.writerows(x)
